...
<head>
    ...
    <!--====== Title ======-->
    <title>Acada Suite | Landing Page</title>
    
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="assets/images/aca_logo.png" type="image/png">
  ...
  <![endif]-->
                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse sub-menu-bar" id="navbarTwo">
                            <ul class="navbar-nav m-auto">
                                ...
                                <li class="nav-item"><a class="page-scroll" href="#services">Video</a></li>
                                <!-- <li class="nav-item"><a class="page-scroll" href="#about">About</a></li> -->
                                <li class="nav-item"><a class="page-scroll" href="#pricing">Course</a></li>
                                <li class="nav-item"><a class="page-scroll" href="#contact">Signup</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="slider-content">
                                    <h1 class="title">Quality,Affordable & Accessible</h1>
                                    <p class="text">
                                    For All Learners
                                    </p>
                        ...
                        <div class="slider-image" id="slider-image-show">
                            ...
                            <form id="contactForm" action="" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-input light-rounded-butt mt-30">
                                            <button class="main-btn light-rounded-two" type="submit">Sign Up</button>
                                        </div> <!-- form input -->
                                    </div>
                                </div> <!-- row -->
                            </form>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-10">
                    <div class="section-title text-center pb-10">
                        <h3 class="title">What Differentiates ACADASUITE</h3>
                        <p class="text">Promoting Quality Education And Making Learning More Interesting to all learners.</p>
                    </div> <!-- row -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-features mt-40">
                        ...
                        <div class="features-content">
                            <p class="text">Our tutors are well-trained professionals who provide reliable, simplified, and validated learning content in both video and text format. They also provide quizzes and tests for the learners.</p>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-features mt-40">
                        ...
                        <div class="features-content">
                            <p class="text">We provide high-quality educational videos that allow for more efficient processing and memory recall. Our videos enable learners to process information in a way that’s natural to them. These videos are accessible at the student’s convenience and can be watched numerous times to assist with coursework and skill mastery.</p>
                            <!-- <a class="features-btn" href="#">LEARN MORE</a> -->
                        </div>
                    </div> <!-- single features -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-features mt-40">
                        ...
                        <div class="features-content">
                            <p class="text">We provide comprehensive text content for each video content. Our learners are able to take quizzes for each subject to test their knowledge of the subject.</p>
                            <!-- <a class="features-btn" href="#">LEARN MORE</a> -->
                        </div>
                    </div> <!-- single features -->
                </div>
    ...
    <section id="contact" class="contact-area" id="contact">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6"  style="margin-top:90px">
                    <div class="contact-map mt-30">
                       <h3 class="mb-5">Sign Up now and get your first free course</h3>
                       <p class="mb-4"> 
                            All Learners now have access to quality learning content.
                            Join us to get the best educational content and achieve excellent grades.
                        </p>
                        <p>
                            With our learning contents, you can learn anywhere, anytime, and at your own pace.
                        </p>
                    </div> <!-- row -->
                </div>
                <div class="col-lg-2"></div>
                <div class="contact-map pt-115 col-lg-4" id="subcribe">
                    <h4 class="contact-title pb-10"><i class=""></i> Register now<span>to grab your course.</span></h4>
            ...
            <div class="contact-info pt-30"  style="margin-top: 60px;">
                <div class="row">
